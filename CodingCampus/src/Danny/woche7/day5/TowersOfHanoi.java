...
public class TowersOfHanoi {
    ...
    public static int quantityDiscs = 3;
    private static char[][] tower1 = new char[quantityDiscs][quantityDiscs + 2];
    private static char[][] tower2 = new char[quantityDiscs][quantityDiscs + 2];
    private static char[][] tower3 = new char[quantityDiscs][quantityDiscs + 2];
    ...
    public static int overestDisk(char[][] towerAktuell) {
        for (int i = 0; i < towerAktuell.length; i++) {
            if (towerAktuell[i].equals('-')) {
                return i;
            } else if (i == towerAktuell.length-1) {
                return towerAktuell.length-1;
            }
        }
        return 0;
    }
    ...
    public static void moveDisk(int quantityDiscs, char[][] tower1, char[][] tower2, char[][] tower3) {
        if (quantityDiscs > 0) {
            ...
            char[] temp = tower3[overestDisk(tower3)];
            tower3[overestDisk(tower3)] = tower1[overestDisk(tower1)];
    ...
    private static void creatEmtyTowers() {
        char[] disc = new char[quantityDiscs + 2];
